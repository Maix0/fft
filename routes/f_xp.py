...
def xp_front(userid):
	...
	return render_template("xp.html", data=cursus, refreshed=refresh, projectsList=projects, whitelist=hardcode_whitelist, theme=userid['theme'], is_admin=userid["admin"])
