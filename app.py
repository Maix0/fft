...
app.jinja_env.globals.update(custom_image=routes.helpers.custom_image)
...
if __name__ == "__main__":
    app.run(
        debug=bool(os.environ.get("F42_DEBUG", default=False)),
        host="0.0.0.0",
        port=int(os.environ.get("F42_PORT")),
    )
