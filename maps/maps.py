...
def available_seats(
    cluster: str, _map: list, exrypz, locations_map: dict, errors_map: dict
):
    return (
        places(exrypz, _map)
        - count_in_cluster(cluster, locations_map)
        - count_in_cluster(cluster, errors_map)
    )
...
havre = map_havre.map
tokyo = map_tokyo.map
available = {66: map_forty2, 53: map_vienna, 62: map_havre, 26: map_tokyo, 1: map_paris}
