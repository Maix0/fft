...
CREATE UNIQUE INDEX IF NOT EXISTS _18251039d0bb48a986bb81583be503b6 ON FRIENDS (who, has);
CREATE UNIQUE INDEX IF NOT EXISTS _b239b6ae13ed4201aec76eb6098a573c ON DEAD_PC (issuer, station);
