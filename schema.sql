...
CREATE UNIQUE INDEX IF NOT EXISTS _7171f5bd99c54495b06cf293ede73b23 ON FRIENDS (who, has);
CREATE UNIQUE INDEX IF NOT EXISTS _3e666512b6db440796f34f07a53f64e0 ON DEAD_PC (issuer, station);
